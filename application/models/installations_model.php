...
class Installations_model extends Crud_model {

    public $table = 'installations';
    public $ctable = 'cinstallations';
    ...
    public function get_list($limit, $offset, $sort_by, $sort_order)
    {
        ...
        $sort_columns = array('id', 'date', 'name', 'contact', 'address', 'description', 'responsible');
