...
class Tel_Tickets_model extends Crud_model
{

	public $table = 'tel_tickets';
	public $ctable = 'ctel_tickets';
	...
	public function get_list($limit, $offset, $sort_by, $sort_order)
	{
		...
		$sort_columns = array('id', 'date', 'phone', 'contact', 'address', 'description', 'open', 'responsible');
	...
	public function get_phones($sort_by = 'id', $sort_order = 'asc')
	{
		$sort_order = ($sort_order == 'desc') ? 'desc' : 'asc';
		$sort_columns = array('id', 'phone');
		$sort_by = in_array($sort_by, $sort_columns) ? $sort_by : 'id';
	...
	(
		...
		(
			'field' => 'phone',
			'label' => 'Контактный номер телефона абонента',
