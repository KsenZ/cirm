	...
	<div class="content">
		...
		<fieldset xmlns="http://www.w3.org/1999/xhtml">
			...
			<div class="control-group<?php if (form_error('name')) echo ' error'; ?>">
				...
				<div class="controls">
					<input type="text" name="open" value="<?php echo set_value('open', $tel_tickets['open']); ?>"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="responsible"
					       value="<?php echo set_value('responsible', $tel_tickets['responsible']); ?>" id="responsible"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="date" value="<?php echo set_value('date', $tel_tickets['date']); ?>"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="phone" value="<?php echo set_value('phone', $tel_tickets['phone']); ?>"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="contact"
					       value="<?php echo set_value('contact', $tel_tickets['contact']); ?>" id="contact"
					       class="input-xlarge" readonly/>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="address"
					       value="<?php echo set_value('address', $tel_tickets['address']); ?>" id="address"
					       class="input-xlarge" readonly/>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="description"
					       value="<?php echo set_value('description', $tel_tickets['description']); ?>" id="description"
					       class="input-xlarge" readonly/>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="comment"
					       value="<?php echo set_value('comment', $tel_tickets['comment']); ?>" id="comment"
					       class="input-xlarge"/>
				</div>
			</div>
			<div class="control-group">
