<div class="span10">
	<div class="content">
		<legend>Список
			подключений <?php echo anchor('installations/add', '<i class="icon-file"></i> Добавить новое', 'class="btn btn-small"'); ?>
			| <?php echo anchor('installations/display_closed', '<i class="icon-remove-circle"></i> Посмотреть выполненные', 'class="btn btn-small"'); ?></legend>
