	...
	<div class="content">
		...
		<fieldset xmlns="http://www.w3.org/1999/xhtml">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="ls_num"
					       value="<?php echo set_value('ls_num', $installations['ls_num']); ?>" id="ls_num"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="phone" value="<?php echo set_value('phone', $installations['contact']); ?>"
