    ...
    <div class="content">
        ...
        <fieldset xmlns="http://www.w3.org/1999/xhtml">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="close" value="<?php echo set_value('close', $tickets['close']); ?>" id="close" class="input-xlarge" readonly/>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="comment" value="<?php echo set_value('comment', $tickets['comment']); ?>" id="comment" class="input-xlarge" readonly/>
                </div>
        </fieldset>
        <?php echo form_close(); ?>    
