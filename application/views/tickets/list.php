<div class="span10">
    <div class="content">
        <legend>Список тикетов <?php echo anchor('tickets/add', '<i class="icon-file"></i> Добавить новый', 'class="btn btn-small"'); ?> | <?php echo anchor('tickets/display_closed', '<i class="icon-remove-circle"></i> Посмотреть закрытые', 'class="btn btn-small"'); ?></legend>
