    ...
    <div class="content">
        ...
        <fieldset xmlns="http://www.w3.org/1999/xhtml">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="open" value="<?=$tickets['open'];?>" id="open" class="input-xlarge" readonly/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="responsible" value="<?=$tickets['responsible'];?>" id="responsible" class="input-xlarge" readonly/>
                </div>
            </div>
            <div class="control-group">
                <label for="date" class="control-label">Дата:</label>
                <div class="controls">
                    <input type="text" name="date" value="<?=$tickets['date'];?>" id="date" class="input-xlarge" readonly/>
                </div>
            </div>
            <div class="control-group">
                <label for="name" class="control-label">Ф.И.О. абонента:</label>
                <div class="controls">
                    <input type="text" name="name" value="<?=$tickets['name'];?>" id="name" class="input-xlarge" readonly/>
                </div>
            </div>
            <div class="control-group">
                <label for="phone" class="control-label">Контактный номер:</label>
                <div class="controls">
                    <input type="text" name="phone" value="<?=$tickets['phone'];?>" id="phone" class="input-xlarge" readonly/>
                </div>
            </div>
            <div class="control-group">
                <label for="address" class="control-label">Адрес:</label>
                <div class="controls">
                    <input type="text" name="address" value="<?=$tickets['address'];?>" id="address" class="input-xlarge" readonly/>
                </div>
            </div>
            <div class="control-group">
                <label for="description" class="control-label">Описание неисправности:</label>
                <div class="controls">
                    <input type="text" name="description" value="<?=$tickets['description'];?>" id="description" class="input-xlarge" readonly/>
                </div>
            </div>
            <div class="control-group">
                <label for="comment" class="control-label">Описание проделанной работы:</label>
                <div class="controls">
                    <input type="text" name="comment" value="<?=$tickets['comment'];?>" id="comment" class="input-xlarge"/>
                </div>
            </div>
            <div class="control-group">
